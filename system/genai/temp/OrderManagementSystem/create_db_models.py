...
try:
    ...
    session.commit()
    test_customer_1 = Customer(name='Customer 1', balance=300, credit_limit=1000)
    test_customer_2 = Customer(name='Customer 2', balance=500, credit_limit=750)
    test_customer_3 = Customer(name='Customer 3', balance=0, credit_limit=1500)
    test_customer_4 = Customer(name='Customer 4', balance=200, credit_limit=1200)
    test_order_1 = Order(customer_id=1, notes='Order 1 notes', amount_total=150)
    test_order_2 = Order(customer_id=2, notes='Order 2 notes', amount_total=0)
    test_order_3 = Order(customer_id=2, notes='Order 3 notes', amount_total=0)
    ...
    test_item_2 = Item(order_id=2, product_id=2, quantity=2, unit_price=0, amount=0)
    test_item_3 = Item(order_id=3, product_id=3, quantity=1, unit_price=0, amount=0)
